...
import com.maven.app.MessageType;
import Controller.PublicEvent;
import Model.Model_Send_Message;
import Model.Model_User_Account;
import Servide.Service;
import com.maven.swing.JIMSendTextPane;
...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/send.png")));
        ...
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/more.png")));
