...
import com.maven.emoji.Emogi;
import com.maven.emoji.Model_Emoji;
import Controller.PublicEvent;
import com.maven.main.Main;
import Model.Model_Send_Message;
import Model.Model_User_Account;
import Servide.Service;
import com.maven.swing.ScrollBar;
import com.maven.swing.WrapLayout;
...
public class Panel_More extends javax.swing.JPanel {
    ...
    private JButton getButtonImage() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/image.png")));
    ...
    private JButton getButtonFile() {
        OptionButton cmd = new OptionButton();
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/link.png")));
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JFileChooser ch = new JFileChooser();
