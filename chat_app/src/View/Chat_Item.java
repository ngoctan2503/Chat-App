...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/maven/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.maven.swing.JIMSendTextPane();
    ...
    private com.maven.swing.JIMSendTextPane txt;
