...
import com.maven.swing.ComponentResizer;
...
public class Main extends javax.swing.JFrame {
   ...
   public Main() {
    ...
    private void init() {
        setIconImage(new ImageIcon(getClass().getResource("/com/maven/icon/icon.png")).getImage());
    ...
    private void initComponents() {
        ...
        cmdMinimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/maven/icon/minimize.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/maven/icon/close.png"))); // NOI18N
